...
// Ajustamos el path para que entre en la subcarpeta del modelo
const loader = new GLTFLoader().setPath("./assets/models/gltf/brutalism/");

// Ahora cargamos el archivo .gltf
